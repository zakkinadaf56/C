/*
Implementation of circular Linked List.                  Name-Nadaf Zakki Noor Mohammed
                                                         Roll No.-20CO40
                                                         Academic Year-2021-2022

Theory about the programme-In a Circular linked list, every element has a link to its next element 
in the sequence and the last element has a link to the first element.
A circular linked list is similarto the singly linked list except that the last node points
to the first node
...
/*
Conclution:I understood why we use the cll and how it is similar to sll 
just the last node points to the 1st in cll.....
